...
main()
{
	...
	typedef struct s_scolaro scolaro;                //Definisco una variabile di tipo scolaro
	int n_studenti,i;
	...
	for(i=0;i<n_studenti;i++)                    //facciamo un ciclo per gli studenti
	{
	...
	for(i=0;i<n_studenti;i++)                     // ciclo per stampare i campi degli studenti
	{
